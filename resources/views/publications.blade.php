                ...
                <div class="lg:col-span-2">
                    ...
                    <article class="bg-sici-card rounded-xl overflow-hidden border border-gray-800 hover:border-sici-red transition duration-300 shadow-2xl group">
                        <div class="h-64 md:h-96 overflow-hidden relative">
                            ...
                            <img src="{{ asset('images/card.jpeg') }}" alt="Post Principal" class="w-full h-full object-cover transform group-hover:scale-105 transition duration-700">
                        </div>
                        
                        <div class="p-8">
                            <div class="flex items-center space-x-2 mb-4">
                                <span class="bg-sici-red text-white text-xs font-bold px-2 py-1 rounded uppercase tracking-wide">Nuevo</span>
                                <span class="text-sici-muted text-sm font-mono">17 Febrero 2026</span>
                            </div>
                            
                            <h2 class="text-2xl md:text-3xl font-bold text-white mb-4 font-display">
                                Modernización Curricular: El futuro de la Ingeniería de Sistemas
                            </h2>
                            
                            <p class="text-gray-400 leading-relaxed mb-6">
                                En esta edición especial analizamos los cambios propuestos para la malla curricular 2026. 
                                Se integran nuevas materias de Inteligencia Artificial, Cloud Computing y Ciberseguridad 
                                defensiva. Descubre cómo afectará esto a los nuevos ingresos y las opciones de convalidación.
                            </p>

                            <a href="#" class="inline-flex items-center text-sici-red font-bold hover:text-white transition">
                    ...
                    <div class="flex flex-col space-y-6">
                        ...
                        <article class="bg-sici-card rounded-lg overflow-hidden border border-gray-800 hover:border-gray-600 transition group flex flex-col md:flex-row lg:flex-col">
                            ...
                            <div class="p-5 flex flex-col justify-center">
                                <span class="text-sici-muted text-xs font-mono mb-1">16 Febrero 2026</span>
                                <h4 class="text-lg font-bold text-white leading-tight group-hover:text-sici-red transition">
                                    Resumen del Bootcamp Frontend 2025
                                </h4>
                            </div>
                        </article>
                        ...
                        <article class="bg-sici-card rounded-lg overflow-hidden border border-gray-800 hover:border-gray-600 transition group flex flex-col md:flex-row lg:flex-col">
                            ...
                            <div class="p-5 flex flex-col justify-center">
                                <span class="text-sici-muted text-xs font-mono mb-1">10 Febrero 2026</span>
                                <h4 class="text-lg font-bold text-white leading-tight group-hover:text-sici-red transition">
                         ...
                         <div class="p-6 bg-gradient-to-br from-sici-card to-gray-900 rounded-lg border border-gray-800 text-center">
                            <p class="text-gray-400 text-sm mb-4">¿Tienes un artículo para compartir?</p>
                            <button class="w-full border border-sici-red text-sici-red hover:bg-sici-red hover:text-white py-2 rounded font-bold transition text-sm">
                                Enviar Propuesta
                            </button>
                         </div>
